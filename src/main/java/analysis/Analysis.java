...
public class Analysis {
	...
	public static List<DataSet> getData(String country, int yearStart, int yearEnd, String analysis) {
		...
		if (analysis.equals("Annual Percentage Change of CO2 Emissions, Energy Use and PM2.5 Air Pollution")) {
		...
		} else if (analysis.equals("Annual Percentage Change of PM2.5 Air Pollution and Forest Area")) {
		...
		} else if (analysis.equals("CO2 Emissions Per GDP")) {
		...
		} else if (analysis.equals("Health Expenditure Per Hospital Beds")) {
		...
		} else if (analysis.equals("Annual Percent Change of Expenditure on Education And Mortality Rate")) {	
		...
		} else if (analysis.equals("Annual Percent Change of Expenditure on Education And Health Expenditure") ) {
	...
	public static List<String> captions(String analysis) {
		...
		} else if (analysis.equals("Average Forest Area")) {
